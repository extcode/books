...
#
# Table structure for table 'tx_books_domain_model_specialprice'
#
CREATE TABLE tx_books_domain_model_specialprice (
    uid int(11) NOT NULL auto_increment,
    pid int(11) DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_books_domain_model_book_related_mm'
#
CREATE TABLE tx_books_domain_model_book_related_mm (
...
CREATE TABLE sys_category (
    book_list_pid int(11) unsigned DEFAULT '0' NOT NULL,
    book_show_pid int(11) unsigned DEFAULT '0' NOT NULL
);

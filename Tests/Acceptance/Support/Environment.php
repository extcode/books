...
namespace Extcode\Books\Tests\Acceptance\Support;
...
final class Environment extends BackendEnvironment
{
    protected $localConfig = [
        ...
        'testExtensionsToLoad' => [
            'extcode/books',
            __DIR__ . '/../../Fixtures/books_test',
        ],
        'phpDatabaseFixtures' => [
            'typo3conf/ext/books/Tests/Fixtures/BackendUserDatabase.php',
            'typo3conf/ext/books/Tests/Fixtures/PagesDatabase.php',
            'typo3conf/ext/books/Tests/Fixtures/ContentDatabase.php',
            'typo3conf/ext/books/Tests/Fixtures/BooksDatabase.php',
        ],
        'pathsToLinkInTestInstance' => [
            'typo3conf/ext/books/Tests/Fixtures/config/sites' => 'typo3conf/sites',
        ],
